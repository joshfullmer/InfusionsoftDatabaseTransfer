...
def transfer_opportunities(
    ...
    # Get auto increment and generate list of ids based on that
    offset = 50
    increment_start = destination.get_auto_increment(
        'ProductInterest') + offset
...
def transfer_jobtojobrecurring(
    ...
    s_jtjr = s_jtjr[s_jtjr['JobId'].notnull() & s_jtjr[
        'JobRecurringId'].notnull()]
